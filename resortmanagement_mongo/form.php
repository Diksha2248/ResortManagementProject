...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
        <div class="container">
            <a class="navbar-brand nav-item" ><img src="logo.png"></a>
        </div>
    </nav>
    <!-- END nav -->
        ...
        <div class="container">
            ...
            <div class="row block-9">
                <div class="col-lg-8 pr-lg-12">
                    ...
                    <form  action="form2.php" id="myForm" method="post" >
                        ...
                        <div class="form-group">
                            <input value="Submit" type="submit" name="submit" style="border-radius: 6px;" class="btn btn-primary py-3 px-5" onclick="alert('Thank you for your feedback!'),sendEmail()">
                       <br>
                       <br>
                       <br>
                        </div>
