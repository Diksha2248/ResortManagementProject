            ...
            <div id="mydiv1">
                  <form action="ca.php" method="POST">
                    ...
                    Check out<input type="date" id="txtDate1" name="checkout" />
                        ...
                        <input type="submit" style="margin-top:5px;margin-left:400px;" class="btn btn-secondary btn-sm " value="Check" id="check">
                      </form>
            </div>
    ...
    <br>
     ...
     <div style="background-color: rgb(196, 221, 223); height: 450px; width: 100%;">
      ...
      <div class="card-group">
          ...
          <a href="rooms.php"><img class="card-img-top" src="./images/bg_2.jpg" alt="Card image cap"height:"200px"  width: "20px"></a>      <div class="card-body">
                  <p class="card-text"><b>Large Family Room</b></p>
              </div>
          </div>
          <div class="card"style=" text-align:center; width: 70px; margin-left: 20px; margin-right: 20px;">
          <a href="rooms.php"><img class="card-img-top" src="./images/img_3.jpg" alt="Card image cap" height:"200px"  width: "20px"></a>  
          <div class="card-body">
                  <p class="card-text"><b>Single Room Cottage</b></p>
              </div>
          </div>
          <div class="card"style="text-align:center; width: 70px; margin-left: 20px; margin-right: 20px;  ">
          <a href="rooms.php"> <img class="card-img-top" src="./images/img_4.jpg" alt="Card image cap" height:"200px"  width: "20px"></a> 
          <div class="card-body">
                <p class="card-text"><b>Classic Bungalow Cottage</b></p>
            </div>
        </div>
        <div class="card"style="text-align:center;width: 70px; margin-left: 20px; margin-right: 20px;">
          <a href="rooms.php"><img class="card-img-top" src="./images/img_5.jpg" alt="Card image cap" height:"200px"  width: "20px"></a>  
          <div class="card-body">
...
<div class="col-md-2 col-sm-2 col-xs-6">
  <a href="services.php">
    ...
    <div class="col-md-2 col-sm-2 col-xs-6">
    <a href="services.php"><img  src="./images/guest.png" alt="Card image cap" style=" border: black solid; border-radius: 50%;margin-left: 30px;margin-right: 45px;">
</a>
 <p> &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp<b>GUEST HOUSE</b> </p> 
    </div>
    <div class="col-md-2 col-sm-2 col-xs-6">
    <a href="services.php"><img  src="./images/wifi2.png"alt="Card image cap" style=" border: black solid; border-radius: 50%;margin-left: 30px;margin-right: 45px;">
       <a>
