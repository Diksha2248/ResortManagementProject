...
$mObj=$db->booking->findOne(array('_id'=>$id));
    }
				...
				<div class="row">
					...
					<div class="col-md-4 col-md-pull-7">
						<div class="booking-form">
                            <br>
                            <br>
							<form action="updatedatabook.php"  name="myForm" onsubmit="return validateForm()" method="post">
								<div class="form-group">
									...
									<input class="form-control" id="name" name="name" type="text" placeholder="name" value="<?php  echo $mObj['name'] ?>">
                                </div>
                                <div class="form-group">
									<span class="form-label">Enter Email</span>
									<input class="form-control" id="email" name="email" type="text" placeholder=" Email" onchange="sendEmail()" value="<?php  echo $mObj['email'] ?>" >
                                </div>
                                <div class="form-group">
									<span class="form-label">Enter Mobile number</span>
									<input class="form-control" type="number"  id="mobileNumber"pattern="[0-9]{10}" name="mobile" placeholder="number" value="<?php  echo $mObj['mobile'] ?>">
                                </div>
                                <div class="form-group">
									<span class="form-label">Address</span>
                                    <textarea class="form-control" name="address" id="" cols="30" rows="2" value="<?php  echo $mObj['address'] ?>"></textarea>     
                                  </div>
                                <div class="form-group">
								...
								<div class="row">
									<div class="col-sm-6">
										<div class="form-group">
											...
											<input class="form-control" type="date" id="txtDate1" name="checkin" value="<?php  echo $mObj['checkin'] ?>" >		</div>
									</div>
									<div class="col-sm-6">
										<div class="form-group">
											<span class="form-label">Check out</span>
											<input class="form-control" type="date" id="txtDate" name="checkout" value="<?php  echo $mObj['checkout'] ?>">
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="form-btn">
                                <input value="Submit" type="submit" name="submit" style="border-radius: 6px;" class="btn btn-primary py-3 px-5" onclick="sendEmail()">
