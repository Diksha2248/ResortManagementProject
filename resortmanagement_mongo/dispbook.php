...
$diff1=strtotime($_POST["checkout"])-strtotime($_POST["checkin"]);
 $_POST['diff']=abs(round($diff1/86400));
...
// echo $diff;
        ...
        switch ($type){
            case "Family Room":
                $_POST['total1']=$roomno*$_POST['diff']*245;
                // echo $total1;
            break;
            case "Bachelors Room":
                $_POST['total1']=$roomno*$_POST['diff']*150;
            break;
            case "Classic Bungalow Cottage":
                $_POST['total1']=$roomno*$_POST['diff']*1000;
            break;
            case "Presidential Room":
                $_POST['total1']=$roomno*$_POST['diff']*350;
            break;        

        }
        $db->booking->insertOne($_POST);
    }
